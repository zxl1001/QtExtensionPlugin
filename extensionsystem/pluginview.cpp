...
PluginView::PluginView(QWidget *parent)
    : QWidget(parent),
      ...
      m_allowCheckStateUpdate(true),C_LOAD(1)
{
    m_ui->setupUi(this);
    ...
    errorIcon = QIcon(QLatin1String(":/extensionsystem/images/error.png"));
    ...
    connect(m_ui->categoryWidget, SIGNAL(currentItemChanged(QTreeWidgetItem*,QTreeWidgetItem*)),this, SLOT(selectPlugin(QTreeWidgetItem*)));
    connect(m_ui->categoryWidget, SIGNAL(itemActivated(QTreeWidgetItem*,int)),this, SLOT(activatePlugin(QTreeWidgetItem*)));
...
{
    connect(m_ui->categoryWidget, SIGNAL(itemChanged(QTreeWidgetItem*,int)),this, SLOT(updatePluginSettings(QTreeWidgetItem*,int)));
...
int PluginView::parsePluginSpecs(QTreeWidgetItem *parentItem, Qt::CheckState &groupState, QList<PluginSpec*> plugins)
{
    ...
    for (int i = 0; i < plugins.length(); ++i)
    {
        ...
        QIcon icon = ok ? m_okIcon : errorIcon;
